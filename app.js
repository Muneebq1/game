...
let check = () => {
    ...
    if (num == random) {
        ...
        box.innerHTML = ''
        container.innerHTML = `<form class="box2 animate__animated animate__fadeInDown">
...
function playAgain() {
    ...
    box2.innerHTML = "";
    error.innerHTML = ""
    container.innerHTML = `<form onsubmit="clickon();return false" class="box animate__animated animate__fadeInDown" id="box">
